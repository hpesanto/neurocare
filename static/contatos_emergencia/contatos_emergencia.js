document.addEventListener('DOMContentLoaded', function () {
    ...
    function openModal(html, mode) {
        ...
        if (mode === 'view' && modal) {
            ...
            } catch (e) { console.error('contatos.openModal view-mode error', e); }
        }
    }
    ...
    async function submitForm(ev) {
        ...
        if (res.ok) {
            ...
            if (json.ok) {
                ...
                const existing = document.getElementById('contato-row-' + json.id);
    ...
    observer.observe(document.querySelector('#contatos-table tbody'), { childList: true, subtree: true });
});
